...
打开 `http://127.0.0.1:8136/` 看“此刻”与留白抽屉，或打开 `http://127.0.0.1:8136/?view=projects` 看项目。示例业务内容与依据均为虚构；少数留白标题经作者许可沿用。留白反馈、抽屉轮换和随手记只在当前页面保留，刷新后重置。执行 Agent、联网写入与后台调度均未接入。[演示讲解说明](DEMO-README.md)
