...
[项目海报](docs/images/huili-poster.png) · [交给 Agent 接手](docs/TAKEOVER.md) · [Skill 入口](SKILL.md) · [能力与边界](docs/CAPABILITIES.md) · [接入契约](docs/ADAPTER.md) · [隐私说明](docs/PRIVACY.md) · [使用许可](docs/LICENSE-FAQ.md)
